...
**STA mode** joins your home Wi-Fi. Once you configure a TCP peer or hub, internet access can extend the mesh well beyond what LoRa alone can cover. The firmware does not join a public hub automatically.
