...
|--------|-------|:--:|:---------:|:-----------:|:--------:|----------|
| **Long Range** | ~300 bps | 12 | 125 kHz | 4/8 | 17 dBm | Maximum distance, low data rate |
| **Balanced** | ~2.4 Kbps | 9 | 250 kHz | 4/5 | 14 dBm | Good range/speed trade-off |
| **Fast** | ~21 Kbps | 7 | 500 kHz | 4/5 | 10 dBm | Short range, higher throughput |
...
<svg viewBox="0 0 600 200" xmlns="http://www.w3.org/2000/svg" fill="none">
  ...
  <text x="460" y="120" text-anchor="middle" fill="#7e8fa2" font-family="Outfit" font-size="9">~300 bps</text>
  ...
  <text x="300" y="80" text-anchor="middle" fill="#7e8fa2" font-family="Outfit" font-size="9">~2.4 Kbps</text>
  ...
  <text x="160" y="38" text-anchor="middle" fill="#7e8fa2" font-family="Outfit" font-size="9">~21 Kbps</text>
